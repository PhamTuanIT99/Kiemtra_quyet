...
function displayuser(listUser){
  ...
  <td class='text-center'><button class='btn btn-outline-primary' data-toggle='modal' data-target='#updatetk'  onclick='edittk(${i})'>Edit</button></td>
  <td class='text-center'><button class='btn btn-outline-primary'  onclick='detele(${i})'>Detele</button></td>
  </tr> `
  }
