...
function addsp(){
  ...
  ttsp=select2[select.selectedIndex].text;
...
function displaysp(listSanPham){
  ...
  <td><p class='text-center mx-auto'>${listSanPham[i].ttsp}</p></td>
  <td style='width: 100px;'><img  class="img " style="width: 100px;height: 100px;" src="img/${listSanPham[i].img}"></img></td>
  <td style='width: 100px;' class='text-center'><button class='btn btn-outline-primary' data-toggle='modal' data-target='#update'  onclick='editsp(${i})'>Edit</button></td>
  <td style='width: 100px;' class='text-center'><button class='btn btn-outline-primary'  onclick='detelesp(${i})'>Detele</button></td>
  </tr>` 
  }   
