...
function login() {
  ...
  listUser.forEach(function (e) {
    if (userlogin == "KA" && passwordlogin == e.password) {
...
function checklogin(){
  ...
  if (showlogin!="") {
    ...
    document.getElementById("mess2").innerHTML= '<a class="text-primary" id="mess" href="#" style="text-decoration: none;">'+showlogin+'</a>'
    ...
    document.getElementById("mess2").innerHTML= '<a class="text-primary" id="mess" href="#" style="text-decoration: none;"  data-toggle="modal" data-target="#login">Đăng nhập</a>'
