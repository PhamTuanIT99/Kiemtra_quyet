...
function loadProduct(ArrayCart) {
  ...
  ArrayCart.forEach(function (p) {
    ...
    products += `
      ...
      <td scope="col"><button class='close text-center' onclick='detelegh(${i})' type='button' title="Xóa ${p.name} ra khỏi giỏ hàng" > 
...
function OK() {
  ...
  document.getElementById("checkshow1").innerHTML = `<a href="#" id="cancel" class="btn btn-outline-primary " style="margin-left: 20px;" onclick="Cancel()"><b>Quay Lại Giỏ Hàng</b></a>`
}
...
function Cancel() {
  ...
  document.getElementById("checkshow1").innerHTML = `<a href="home.html"  class="btn btn-outline-primary " style="margin-left: 20px;" onclick="Cancel()">Tiếp Tục Xem Sản Phẩm</a>`
}
...
function loadCard(ArrayCart) {
  ...
  products += `
        ...
        <tr>
            ...
            <td></td>
            <td></td>
           <td id="gg" class="text-primary"></td>
        </tr>
        <tr>
...
function tttt() {
  ...
  if (showlogin == "") {
    ...
    document.getElementById("checkshow1").innerHTML = `<a href="home.html" id="cancel" class="btn btn-outline-primary " style="margin-left: 20px;"><b>Tiếp tục mua hàng</b></a>`
